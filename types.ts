export type ISO_639_2_LanguageEntry = {
    ...
    alpha3_terminology: string, // ISO 639-2/T - 3 letter code (based on native name)
...
export type ISO_639_3_LanguageEntry = {
    ...
    part2b: string | null, // ISO 639-2/B - 3 letter code (based on English name)
    part2t: string | null, // ISO 639-2/T - 3 letter code (based on native name)
